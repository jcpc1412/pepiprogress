...
export const COMPOUND_CATALOG: readonly CatalogCompound[] = [
  ...
  // ── GH secretagogues (additional) ────────────────────────────────────────
  {
    ...
    canonicalName: 'CJC without DAC',
    aliases: ['mod-grf', 'mod grf 1-29', 'cjc no dac', 'modified grf'],
    type: 'peptide',
    controlled: false,
    effectTags: ['recovery', 'muscle', 'sleep'],
    monitoringTags: [],
    commonUses: ['gh secretagogue'],
    injectable: true,
    reconstituted: true,
  ...
  {
    slug: 'hgh-191aa',
    canonicalName: 'HGH 191AA',
    aliases: ['hgh', 'somatropin', 'recombinant hgh', 'growth hormone'],
    type: 'peptide',
    controlled: false,
    effectTags: ['muscle', 'recovery', 'fat_loss'],
    monitoringTags: ['glucose'],
    commonUses: ['growth hormone replacement', 'anti-aging'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [4, 10],
  },
  {
    slug: 'gonadorelin',
  ...
  {
    slug: 'triptorelin',
    canonicalName: 'Triptorelin',
    aliases: ['decapeptyl', 'trelstar'],
    type: 'peptide',
    controlled: false,
    effectTags: ['hormonal'],
    monitoringTags: ['testosterone_total', 'estradiol'],
    commonUses: ['HPTA restart', 'PCT'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [0.1, 0.5],
  },
  {
    slug: 'hmg',
    canonicalName: 'HMG',
    aliases: ['human menopausal gonadotropin', 'menopur'],
    type: 'peptide',
    controlled: false,
    effectTags: ['hormonal'],
    monitoringTags: ['testosterone_total', 'estradiol'],
    commonUses: ['testicular support', 'fertility'],
    injectable: true,
    reconstituted: true,
  },
  {
    slug: 'ipamorelin-cjc-blend',
    canonicalName: 'Ipamorelin/CJC No DAC Blend',
    aliases: ['ipamorelin cjc blend', 'ipa cjc'],
    type: 'peptide',
    controlled: false,
    effectTags: ['recovery', 'muscle', 'sleep'],
    monitoringTags: [],
    commonUses: ['gh secretagogue stack'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [5, 10],
  },
  {
    slug: 'acth',
    canonicalName: 'ACTH',
    aliases: ['adrenocorticotropic hormone', 'cosyntropin'],
    type: 'peptide',
    controlled: false,
    effectTags: ['recovery'],
    monitoringTags: [],
    commonUses: ['adrenal support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [1],
  },
  ...
  // ── Bioregulators (Khavinson short-peptide organ-specific series) ─────────
  {
    slug: 'bonomarlot',
    canonicalName: 'Bonomarlot',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing', 'recovery'],
    monitoringTags: [],
    commonUses: ['bone marrow support', 'immune support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'bonothyrk',
    canonicalName: 'Bonothyrk',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['parathyroid support', 'bone health'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'bronchogen',
    canonicalName: 'Bronchogen',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['lung support', 'respiratory'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'cardiogen',
    canonicalName: 'Cardiogen',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing', 'recovery'],
    monitoringTags: [],
    commonUses: ['cardiac support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'cartalax',
    canonicalName: 'Cartalax',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing', 'recovery'],
    monitoringTags: [],
    commonUses: ['cartilage support', 'joint health'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'cerluten',
    canonicalName: 'Cerluten',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['cognition'],
    monitoringTags: [],
    commonUses: ['brain support', 'neuroprotection'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'chonluten',
    canonicalName: 'Chonluten',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['lung support', 'bronchial health'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'cortagen',
    canonicalName: 'Cortagen',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing', 'cognition'],
    monitoringTags: [],
    commonUses: ['nervous system support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'crystagen',
    canonicalName: 'Crystagen',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['prostate support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'endoluten',
    canonicalName: 'Endoluten',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['sleep', 'recovery'],
    monitoringTags: [],
    commonUses: ['pineal gland support', 'longevity'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  ...
  {
    slug: 'gotratix',
    canonicalName: 'Gotratix',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['muscle', 'recovery'],
    monitoringTags: [],
    commonUses: ['skeletal muscle support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'libidon',
    canonicalName: 'Libidon',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['libido', 'healing'],
    monitoringTags: [],
    commonUses: ['prostate support', 'libido'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'livagen',
    canonicalName: 'Livagen',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing', 'recovery'],
    monitoringTags: [],
    commonUses: ['cardiovascular support', 'liver'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'normoftal',
    canonicalName: 'Normoftal',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['eye support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'ovagen',
    canonicalName: 'Ovagen',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['liver support', 'gastrointestinal'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'pancragen',
    canonicalName: 'Pancragen',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: ['glucose'],
    commonUses: ['pancreas support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'pielotax',
    canonicalName: 'Pielotax',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['kidney support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  ...
  {
    slug: 'retinalamin',
    canonicalName: 'Retinalamin',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['retina support', 'eye health'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [5, 10],
  },
  {
    slug: 'sigumir',
    canonicalName: 'Sigumir',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing', 'recovery'],
    monitoringTags: [],
    commonUses: ['joint support', 'cartilage'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'svetinorm',
    canonicalName: 'Svetinorm',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['liver support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'testagen',
    canonicalName: 'Testagen',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['hormonal', 'libido'],
    monitoringTags: ['testosterone_total'],
    commonUses: ['testicular support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  ...
  {
    slug: 'thymalin',
    canonicalName: 'Thymalin',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing', 'recovery'],
    monitoringTags: [],
    commonUses: ['thymus support', 'immune support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  ...
  {
    slug: 'thyreogen',
    canonicalName: 'Thyreogen',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['thyroid support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'ventfort',
    canonicalName: 'Ventfort',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing', 'recovery'],
    monitoringTags: [],
    commonUses: ['vascular support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'vesilut',
    canonicalName: 'Vesilut',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['urinary support', 'bladder health'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    slug: 'vesugen',
    canonicalName: 'Vesugen',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing', 'recovery'],
    monitoringTags: [],
    commonUses: ['cardiovascular support'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  {
    ...
    effectTags: ['healing', 'recovery'],
    monitoringTags: [],
    commonUses: ['immune support', 'longevity'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [5, 10],
  },
  {
    slug: 'zhenoluten',
    canonicalName: 'Zhenoluten',
    aliases: [],
    type: 'peptide',
    controlled: false,
    effectTags: ['hormonal', 'healing'],
    monitoringTags: ['estradiol'],
    commonUses: ['ovarian support', 'female hormonal'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10, 20],
  },
  ...
  // ── Nootropic / brain ─────────────────────────────────────────────────────
  {
    ...
    effectTags: ['cognition', 'mood'],
    monitoringTags: [],
    commonUses: ['nootropic', 'neuroprotection'],
    injectable: false,
    reconstituted: false,
  },
  {
    ...
    effectTags: ['cognition'],
    monitoringTags: [],
    commonUses: ['nootropic', 'BDNF mimetic'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [5, 10],
  },
  {
    ...
    effectTags: ['cognition', 'mood'],
    monitoringTags: [],
    commonUses: ['antidepressant', 'BDNF mimetic'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [5, 10],
  },
  {
    ...
    type: 'peptide',
    controlled: false,
    effectTags: ['cognition', 'healing'],
    monitoringTags: [],
    commonUses: ['neuroprotection', 'cognitive support'],
    injectable: true,
    reconstituted: false,
  },
  {
  ...
  {
    slug: 'foxo4-dri',
    canonicalName: 'FOXO4-DRI',
    aliases: ['foxo4dri', 'foxo4'],
    type: 'peptide',
    controlled: false,
    effectTags: ['recovery', 'healing'],
    monitoringTags: [],
    commonUses: ['senolytic', 'longevity'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [5, 10],
  },
  ...
  // ── Hormones / peptide hormones ───────────────────────────────────────────
  {
    ...
    aliases: ['miacalcin', 'calcimar'],
    type: 'peptide',
    controlled: false,
    effectTags: ['healing'],
    monitoringTags: [],
    commonUses: ['bone health', 'calcium regulation'],
    injectable: true,
    reconstituted: false,
  },
  {
    slug: 'igf-1',
    canonicalName: 'IGF-1',
    aliases: ['igf1', 'insulin-like growth factor 1'],
    type: 'peptide',
    controlled: false,
    effectTags: ['muscle', 'recovery'],
    monitoringTags: ['glucose'],
    ...
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [0.1, 1],
  },
  {
    slug: 'melanotan-1',
    canonicalName: 'Melanotan I',
    aliases: ['mt1', 'mt-i', 'afamelanotide'],
    type: 'peptide',
    controlled: false,
    effectTags: ['skin'],
    monitoringTags: [],
    commonUses: ['tanning', 'photoprotection'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [10],
  },
  {
    slug: 'peg-mgf',
    canonicalName: 'PEG-MGF',
    aliases: ['pegylated mgf', 'peg mgf'],
    type: 'peptide',
    controlled: false,
    effectTags: ['muscle', 'recovery'],
    monitoringTags: [],
    commonUses: ['muscle growth', 'satellite cell activation'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [2, 5],
  },
  ...
  // ── Metabolic / supplement ────────────────────────────────────────────────
  {
    slug: 'aicar',
    canonicalName: 'AICAR',
    aliases: ['acadesine', 'aicar peptide'],
    type: 'other',
    controlled: false,
    effectTags: ['fat_loss', 'recovery'],
    monitoringTags: [],
    commonUses: ['endurance', 'metabolic', 'AMPK activator'],
    injectable: true,
    reconstituted: true,
    commonVialSizesMg: [50, 100],
  },
  {
    ...
    type: 'supplement',
    controlled: false,
    effectTags: ['healing', 'skin'],
    monitoringTags: [],
    commonUses: ['antioxidant', 'detox', 'skin'],
    injectable: true,
    reconstituted: false,
  },
  {
    ...
    aliases: ['lcarnitine', 'carnitine'],
    type: 'supplement',
    controlled: false,
    effectTags: ['fat_loss', 'recovery'],
    monitoringTags: [],
    commonUses: ['fat metabolism', 'energy'],
    injectable: true,
    reconstituted: false,
  },
  {
    slug: 'lipo-b',
    canonicalName: 'Lipo-B',
    aliases: ['lipo b', 'lipotropic b'],
    type: 'other',
    controlled: false,
    effectTags: ['fat_loss'],
    monitoringTags: [],
    commonUses: ['fat loss', 'energy'],
    injectable: true,
    reconstituted: false,
  },
